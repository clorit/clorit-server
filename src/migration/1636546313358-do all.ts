...
export class doAll1636546313358 implements MigrationInterface {
    name = 'doAll1636546313358'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "media" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "isCeleb" boolean NOT NULL, CONSTRAINT "PK_f4e0fcac36e050de337b670d8bd" PRIMARY KEY ("id"))`);
